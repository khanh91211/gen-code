...
public class LoggingUtil {
  public void displayReq(Logger log, HttpServletRequest request, Object body) {
  ...
  public void displayResp(Logger log, HttpServletRequest request, HttpServletResponse response,
      Object body) {
