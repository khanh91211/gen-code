...
public class Inflector {
  ...
  protected void initialize() {
    ...
    inflect.addUncountable("advice", "aggression", "assistance", "attention", "accommodation", "advertising", "air",
        "athletics", "access", "adulthood", "alcohol", "applause", "agriculture", "atmosphere", "anger", "art",
        "absence", "aid", "arithmetic", "age", "beauty", "beef", "bravery", "business", "blood", "botany", "bacon",
        "baggage", "ballet", "butter", "biology", "beer", "bread", "behaviour", "cake", "cash", "chaos", "clothing",
        "confidence", "compassion", "calm", "corruption", "courage", "comprehension", "cheese", "currency", "carbon",
        "cardboard", "chalk", "chess", "coal", "commerce", "confusion", "cookery", "countryside", "crockery", "cutlery",
        "chocolate", "content", "cotton", "childhood", "coffee", "danger", "data", "dancing", "democracy", "damage",
        "darkness", "determination", "delight", "depression", "driving", "dignity", "dessert", "design", "dust",
        "distribution", "dirt", "duty", "uncountable nouns list: e – h", "education", "economics", "equipment", "earth",
        "expense", "energy", "electricity", "enthusiasm", "environment", "enjoyment", "envy", "evil", "engineering",
        "entertainment", "evolution", "existence", "ethics", "evidence", "employment", "experience", "failure", "fire",
        "fiction", "fashion", "forgiveness", "faith", "flour", "flu", "fear", "fun", "fame", "freedom", "food",
        "finance", "fruit", "fuel", "friendship", "furniture", "flesh", "gasoline", "genetics", "garbage", "growth",
        "grief", "grammar", "garlic", "gossip", "gold", "gymnastics", "glass", "grass", "golf", "gratitude", "ground",
        "guilt", "harm", "hair", "hardware", "hydrogen", "help", "happiness", "health", "hate", "hope", "hospitality",
        "homework", "heat", "hatred", "hunger", "honey", "humour", "honesty", "height", "housework", "history",
        "uncountable nouns list: i – o", "ice", "imagination", "information", "independence", "infrastructure",
        "ice cream", "importance", "intelligence", "industry", "irony", "injustice", "innocence", "iron", "insurance",
        "inflation", "judo", "jealousy", "jam", "jewelery", "joy", "juice", "justice", "kindness", "knowledge",
        "karate", "laughter", "labour", "lava", "livestock", "luggage", "lightning", "land", "leather", "linguistics",
        "light", "loneliness", "lack", "litter", "luck", "love", "leisure", "logic", "literature", "machinery", "mail",
        "mankind", "marriage", "money", "magic", "marble", "mercy", "music", "meat", "management", "mathematics",
        "moonlight", "methane", "milk", "metal", "mayonnaise", "mud", "mist", "motivation", "motherhood", "measles",
        "nature", "nitrogen", "nutrition", "noise", "news", "nonsense", "nurture", "obedience", "obesity", "oxygen",
        "oil", "uncountable nouns list: p – z", "paper", "passion", "poetry", "parking", "pressure", "perfume",
        "physics", "psychology", "peel", "pepper", "patience", "permission", "peace", "philosophy", "plastic",
        "progress", "production", "pollution", "pleasure", "pork", "petrol", "pronunciation", "pride", "policy",
        "purity", "poverty", "punctuation", "power", "produce", "protection", "publicity", "pasta", "pay", "pain",
        "painting", "quartz", "quality", "quantity", "reliability", "rum", "recreation", "reality", "rubbish",
        "revenge", "racism", "rice", "relief", "respect", "rain", "relaxation", "research", "religion", "salt",
        "safety", "salad", "scaffolding", "soil", "satisfaction", "sand", "satire", "security", "sorrow", "seafood",
        "speed", "scenery", "sewing", "strength", "space", "software", "seaside", "stream", "stupidity", "shopping",
        "stress", "shame", "spite", "steam", "silence", "sunshine", "sleep", "status", "success", "soup", "snow",
        "smoking", "silver", "symmetry", "spaghetti", "spelling", "soap", "sport", "stuff", "sugar", "smoke", "tea",
        "tolerance", "thirst", "technology", "trousers", "tennis", "trade", "timber", "turbulence", "toothpaste",
        "time", "traffic", "travel", "toast", "thunder", "transportation", "trust", "trouble", "temperature",
        "understanding", "usage", "underwear", "unemployment", "unity", "violence", "veal", "validity", "vitality",
        "vinegar", "vision", "vegetation", "vegetarianism", "vengeance", "warmth", "weight", "whiskey", "weather",
        "wildlife", "water", "welfare", "wine", "wisdom", "wood", "wealth", "wheat", "wool", "width", "work", "yoga",
        "youth", "yeast");
  }
